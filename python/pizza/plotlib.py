...
def hammer2cart(ttheta, pphi, colat=False):
    ...
    :returns: a tuple that contains two [nphi, ntheta] arrays: the x, y
              meshgrid used in contour plots
...
def merContour(data, radius, colat=None, label=None, levels=65, cm='seismic',
    ...
    :param radius: the input radius
    :type radius: numpy.ndarray
    :param colat: the input colatitude
    :type colat: numpy.ndarray
    :param label: the name of the input physical quantity you want to
                  display
    :type label: str
...
def radialContour(data, rad=0.85, label=None, lon_0=0., vmax=None,
                  vmin=None, lat_0=30., levels=65, cm='seismic',
