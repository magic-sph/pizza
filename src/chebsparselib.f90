...
!------------------------------------------------------------------------------
   function intcheb4rmult4hmult8(a, b, n, len_stencil) result(stencil)
      ...
      &              *(dn+3.0_cp))
      stencil(ku-13)=-a**14*(2.0_cp*a**2*dn+a**2+8.0_cp*a*b*dn-8.0_cp*a*b &
      &              -62.0_cp*b**2*dn+62.0_cp*b**2)/(16384.0_cp*dn*(dn-1.0_cp)*(dn+1.0_cp &
      &              )*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-12)=-a**13*b*(19.0_cp*a**2*dn+17.0_cp*a**2+80.0_cp*a*b*dn &
      &              -80.0_cp*a*b-180.0_cp*b**2*dn+180.0_cp*b**2)/(8192.0_cp*dn*(dn-1.0_cp &
      &              )*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-11)=3.0_cp*a**12*(2.0_cp*a**4*dn**2+a**4*dn-5.0_cp*a**4+16.0_cp &
      &              *a**3*b*dn**2-16.0_cp*a**3*b*dn-32.0_cp*a**3*b-68.0_cp*a**2*b**2*dn**2 &
      &              -44.0_cp*a**2*b**2*dn+360.0_cp*a**2*b**2-448.0_cp*a*b**3*dn**2+1344.0_cp &
      &              *a*b**3*dn-896.0_cp*a*b**3+428.0_cp*b**4*dn**2-1284.0_cp*b**4*dn+856.0_cp &
      &              *b**4)/(16384.0_cp*dn*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp &
      &              )*(dn+3.0_cp))
      stencil(ku-10)=a**11*b*(43.0_cp*a**4*dn**2+63.0_cp*a**4*dn-118.0_cp &
      &              *a**4+368.0_cp*a**3*b*dn**2-144.0_cp*a**3*b*dn-1184.0_cp*a**3*b+132.0_cp &
      &              *a**2*b**2*dn**2-2556.0_cp*a**2*b**2*dn+4584.0_cp*a**2*b**2-3072.0_cp &
      &              *a*b**3*dn**2+9216.0_cp*a*b**3*dn-6144.0_cp*a*b**3+1440.0_cp*b**4*dn**2 &
      &              -4320.0_cp*b**4*dn+2880.0_cp*b**4)/(8192.0_cp*dn*(dn-2.0_cp)*(dn-1.0_cp &
      &              )*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-9)=-a**10*(6.0_cp*a**6*dn**3+15.0_cp*a**6*dn**2-99.0_cp* &
      &              a**6*dn+30.0_cp*a**6+88.0_cp*a**5*b*dn**3-48.0_cp*a**5*b*dn**2-952.0_cp &
      &              *a**5*b*dn+912.0_cp*a**5*b-106.0_cp*a**4*b**2*dn**3-1068.0_cp*a**4* &
      &              b**2*dn**2+3634.0_cp*a**4*b**2*dn+1572.0_cp*a**4*b**2-4096.0_cp*a** &
      &              3*b**3*dn**3+8448.0_cp*a**3*b**3*dn**2+35584.0_cp*a**3*b**3*dn-72192.0_cp &
      &              *a**3*b**3-6864.0_cp*a**2*b**4*dn**3+56592.0_cp*a**2*b**4*dn**2-152544.0_cp &
      &              *a**2*b**4*dn+133632.0_cp*a**2*b**4+16512.0_cp*a*b**5*dn**3-99072.0_cp &
      &              *a*b**5*dn**2+181632.0_cp*a*b**5*dn-99072.0_cp*a*b**5-3968.0_cp*b** &
      &              6*dn**3+23808.0_cp*b**6*dn**2-43648.0_cp*b**6*dn+23808.0_cp*b**6)/(16384.0_cp &
      &              *dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn &
      &              +3.0_cp))
      stencil(ku-8)=-3.0_cp*a**9*b*(9.0_cp*a**6*dn**3+54.0_cp*a**6*dn**2-181.0_cp &
      &              *a**6*dn-66.0_cp*a**6+160.0_cp*a**5*b*dn**3+192.0_cp*a**5*b*dn**2-2400.0_cp &
      &              *a**5*b*dn+1152.0_cp*a**5*b+536.0_cp*a**4*b**2*dn**3-1968.0_cp*a**4 &
      &              *b**2*dn**2-3944.0_cp*a**4*b**2*dn+15072.0_cp*a**4*b**2-1536.0_cp*a**3 &
      &              *b**3*dn**3-3072.0_cp*a**3*b**3*dn**2+44544.0_cp*a**3*b**3*dn-64512.0_cp &
      &              *a**3*b**3-4896.0_cp*a**2*b**4*dn**3+35136.0_cp*a**2*b**4*dn**2-82656.0_cp &
      &              *a**2*b**4*dn+63936.0_cp*a**2*b**4+4352.0_cp*a*b**5*dn**3-26112.0_cp &
      &              *a*b**5*dn**2+47872.0_cp*a*b**5*dn-26112.0_cp*a*b**5-512.0_cp*b**6*dn**3 &
      &              +3072.0_cp*b**6*dn**2-5632.0_cp*b**6*dn+3072.0_cp*b**6)/(8192.0_cp*dn &
      &              *(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp &
      &              ))
      stencil(ku-7)=-a**8*(9.0_cp*a**8*dn**3-75.0_cp*a**8*dn**2+39.0_cp*a**8 &
      &              *dn+165.0_cp*a**8+32.0_cp*a**7*b*dn**3-768.0_cp*a**7*b*dn**2+1312.0_cp &
      &              *a**7*b*dn+1152.0_cp*a**7*b-8.0_cp*a**6*b**2*dn**3-384.0_cp*a**6*b**2* &
      &              dn**2+6872.0_cp*a**6*b**2*dn-9504.0_cp*a**6*b**2+3200.0_cp*a**5*b** &
      &              3*dn**3+13824.0_cp*a**5*b**3*dn**2-49280.0_cp*a**5*b**3*dn-62976.0_cp &
      &              *a**5*b**3+20216.0_cp*a**4*b**4*dn**3-23520.0_cp*a**4*b**4*dn**2-343544.0_cp &
      &              *a**4*b**4*dn+696480.0_cp*a**4*b**4-1280.0_cp*a**3*b**5*dn**3-190464.0_cp &
      &              *a**3*b**5*dn**2+976640.0_cp*a**3*b**5*dn-1181184.0_cp*a**3*b**5-59648.0_cp &
      &              *a**2*b**6*dn**3+405504.0_cp*a**2*b**6*dn**2-894208.0_cp*a**2*b**6*dn &
      &              +643584.0_cp*a**2*b**6+22528.0_cp*a*b**7*dn**3-135168.0_cp*a*b**7*dn**2 &
      &              +247808.0_cp*a*b**7*dn-135168.0_cp*a*b**7-1024.0_cp*b**8*dn**3+6144.0_cp &
      &              *b**8*dn**2-11264.0_cp*b**8*dn+6144.0_cp*b**8)/(16384.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-6)=-a**8*b*(49.0_cp*a**7*dn**3-294.0_cp*a**7*dn**2-301.0_cp &
      &              *a**7*dn+1026.0_cp*a**7+224.0_cp*a**6*b*dn**3-3648.0_cp*a**6*b*dn** &
      &              2+1504.0_cp*a**6*b*dn+12672.0_cp*a**6*b-632.0_cp*a**5*b**2*dn**3-11760.0_cp &
      &              *a**5*b**2*dn**2+41288.0_cp*a**5*b**2*dn+20640.0_cp*a**5*b**2-512.0_cp &
      &              *a**4*b**3*dn**3+21504.0_cp*a**4*b**3*dn**2+86528.0_cp*a**4*b**3*dn &
      &              -439296.0_cp*a**4*b**3+28448.0_cp*a**3*b**4*dn**3+22848.0_cp*a**3*b**4 &
      &              *dn**2-741152.0_cp*a**3*b**4*dn+1249728.0_cp*a**3*b**4+15104.0_cp*a**2 &
      &              *b**5*dn**3-247296.0_cp*a**2*b**5*dn**2+949504.0_cp*a**2*b**5*dn-1030656.0_cp &
      &              *a**2*b**5-30208.0_cp*a*b**6*dn**3+199680.0_cp*a*b**6*dn**2-424448.0_cp &
      &              *a*b**6*dn+291840.0_cp*a*b**6+4096.0_cp*b**7*dn**3-24576.0_cp*b**7*dn**2 &
      &              +45056.0_cp*b**7*dn-24576.0_cp*b**7)/(8192.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp &
      &              )*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-5)=3.0_cp*a**8*(10.0_cp*a**8*dn**3-17.0_cp*a**8*dn**2-85.0_cp &
      &              *a**8*dn+78.0_cp*a**8+104.0_cp*a**7*b*dn**3-304.0_cp*a**7*b*dn**2-776.0_cp &
      &              *a**7*b*dn+1296.0_cp*a**7*b+282.0_cp*a**6*b**2*dn**3-1580.0_cp*a**6 &
      &              *b**2*dn**2+222.0_cp*a**6*b**2*dn+6660.0_cp*a**6*b**2+1792.0_cp*a** &
      &              5*b**3*dn**2+19200.0_cp*a**5*b**3*dn-19968.0_cp*a**5*b**3+2352.0_cp &
      &              *a**4*b**4*dn**3+34160.0_cp*a**4*b**4*dn**2-26848.0_cp*a**4*b**4*dn &
      &              -341760.0_cp*a**4*b**4+14464.0_cp*a**3*b**5*dn**3-25856.0_cp*a**3*b**5 &
      &              *dn**2-475776.0_cp*a**3*b**5*dn+1269504.0_cp*a**3*b**5-30592.0_cp*a**2 &
      &              *b**6*dn**3-70912.0_cp*a**2*b**6*dn**2+1015168.0_cp*a**2*b**6*dn-1581312.0_cp &
      &              *a**2*b**6-16384.0_cp*a*b**7*dn**3+188416.0_cp*a*b**7*dn**2-630784.0_cp &
      &              *a*b**7*dn+638976.0_cp*a*b**7+8192.0_cp*b**8*dn**3-53248.0_cp*b**8*dn**2 &
      &              +110592.0_cp*b**8*dn-73728.0_cp*b**8)/(16384.0_cp*dn*(dn-3.0_cp)*(dn &
      &              -2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-4)=a**8*b*(97.0_cp*a**7*dn**3+6.0_cp*a**7*dn**2-1033.0_cp &
      &              *a**7*dn-54.0_cp*a**7+1040.0_cp*a**6*b*dn**3-1248.0_cp*a**6*b*dn**2 &
      &              -12560.0_cp*a**6*b*dn+5472.0_cp*a**6*b+3740.0_cp*a**5*b**2*dn**3-14472.0_cp &
      &              *a**5*b**2*dn**2-46940.0_cp*a**5*b**2*dn+89448.0_cp*a**5*b**2+3072.0_cp &
      &              *a**4*b**3*dn**3-43008.0_cp*a**4*b**3*dn**2+64512.0_cp*a**4*b**3*dn &
      &              +479232.0_cp*a**4*b**3+2592.0_cp*a**3*b**4*dn**3+132288.0_cp*a**3*b**4 &
      &              *dn**2+343392.0_cp*a**3*b**4*dn-2463552.0_cp*a**3*b**4+74752.0_cp*a**2 &
      &              *b**5*dn**3-110592.0_cp*a**2*b**5*dn**2-1650688.0_cp*a**2*b**5*dn+3929088.0_cp &
      &              *a**2*b**5-43008.0_cp*a*b**6*dn**3-122880.0_cp*a*b**6*dn**2+1523712.0_cp &
      &              *a*b**6*dn-2304000.0_cp*a*b**6-12288.0_cp*b**7*dn**3+122880.0_cp*b**7* &
      &              dn**2-380928.0_cp*b**7*dn+368640.0_cp*b**7)/(8192.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku-3)=-a**8*(22.0_cp*a**8*dn**3+99.0_cp*a**8*dn**2-328.0_cp &
      &              *a**8*dn-201.0_cp*a**8+304.0_cp*a**7*b*dn**3+960.0_cp*a**7*b*dn**2-4816.0_cp &
      &              *a**7*b*dn-1440.0_cp*a**7*b+1268.0_cp*a**6*b**2*dn**3+2208.0_cp*a** &
      &              6*b**2*dn**2-26492.0_cp*a**6*b**2*dn+9288.0_cp*a**6*b**2-320.0_cp*a**5 &
      &              *b**3*dn**3-3456.0_cp*a**5*b**3*dn**2-34240.0_cp*a**5*b**3*dn+150144.0_cp &
      &              *a**5*b**3-15036.0_cp*a**4*b**4*dn**3+30072.0_cp*a**4*b**4*dn**2+293484.0_cp &
      &              *a**4*b**4*dn+540792.0_cp*a**4*b**4-15360.0_cp*a**3*b**5*dn**3+430080.0_cp &
      &              *a**3*b**5*dn**2+46080.0_cp*a**3*b**5*dn-5575680.0_cp*a**3*b**5+54272.0_cp &
      &              *a**2*b**6*dn**3-663552.0_cp*a**2*b**6*dn**2-1768448.0_cp*a**2*b**6 &
      &              *dn+10288128.0_cp*a**2*b**6-221184.0_cp*a*b**7*dn**3+466944.0_cp*a* &
      &              b**7*dn**2+3219456.0_cp*a*b**7*dn-7888896.0_cp*a*b**7+36864.0_cp*b**8* &
      &              dn**3+86016.0_cp*b**8*dn**2-1191936.0_cp*b**8*dn+1806336.0_cp*b**8) &
      &              /(16384.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn &
      &              +2.0_cp)*(dn+3.0_cp))
      stencil(ku-2)=-3.0_cp*a**8*b*(19.0_cp*a**7*dn**2+21.0_cp*a**7*dn-114.0_cp &
      &              *a**7+272.0_cp*a**6*b*dn**2+48.0_cp*a**6*b*dn-1632.0_cp*a**6*b+1564.0_cp &
      &              *a**5*b**2*dn**2-1772.0_cp*a**5*b**2*dn-9640.0_cp*a**5*b**2+4096.0_cp &
      &              *a**4*b**3*dn**2-16384.0_cp*a**4*b**3*dn-18432.0_cp*a**4*b**3+1856.0_cp &
      &              *a**3*b**4*dn**2-55616.0_cp*a**3*b**4*dn+276864.0_cp*a**3*b**4+1024.0_cp &
      &              *a**2*b**5*dn**2+177152.0_cp*a**2*b**5*dn-627712.0_cp*a**2*b**5+22528.0_cp &
      &              *a*b**6*dn**2-247808.0_cp*a*b**6*dn+550912.0_cp*a*b**6-20480.0_cp*b**7 &
      &              *dn**2+118784.0_cp*b**7*dn-172032.0_cp*b**7)/(8192.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp))
      stencil(ku-1)=-a**8*(22.0_cp*a**8*dn**2-209.0_cp*a**8*dn+255.0_cp*a**8 &
      &              +216.0_cp*a**7*b*dn**2-2592.0_cp*a**7*b*dn+3720.0_cp*a**7*b+1014.0_cp &
      &              *a**6*b**2*dn**2-13512.0_cp*a**6*b**2*dn+24738.0_cp*a**6*b**2+4096.0_cp &
      &              *a**5*b**3*dn**2-34304.0_cp*a**5*b**3*dn+90624.0_cp*a**5*b**3+18016.0_cp &
      &              *a**4*b**4*dn**2-23840.0_cp*a**4*b**4*dn+103296.0_cp*a**4*b**4+59648.0_cp &
      &              *a**3*b**5*dn**2+45056.0_cp*a**3*b**5*dn-1830144.0_cp*a**3*b**5+10496.0_cp &
      &              *a**2*b**6*dn**2-1073152.0_cp*a**2*b**6*dn+4842240.0_cp*a**2*b**6+81920.0_cp &
      &              *a*b**7*dn**2+1138688.0_cp*a*b**7*dn-4694016.0_cp*a*b**7+90112.0_cp &
      &              *b**8*dn**2-856064.0_cp*b**8*dn+1781760.0_cp*b**8)/(16384.0_cp*dn*(dn &
      &              -3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+3.0_cp))
      stencil(ku)=a**8*b*(9.0_cp*a**7*dn**2+45.0_cp*a**7*dn+294.0_cp*a**7 &
      &              +192.0_cp*a**6*b*dn**2+960.0_cp*a**6*b*dn+3072.0_cp*a**6*b+1616.0_cp &
      &              *a**5*b**2*dn**2+8080.0_cp*a**5*b**2*dn+9216.0_cp*a**5*b**2+7168.0_cp &
      &              *a**4*b**3*dn**2+35840.0_cp*a**4*b**3*dn-49152.0_cp*a**4*b**3+15296.0_cp &
      &              *a**3*b**4*dn**2+76480.0_cp*a**3*b**4*dn-1094784.0_cp*a**3*b**4-43520.0_cp &
      &              *a**2*b**5*dn**2-217600.0_cp*a**2*b**5*dn+2672640.0_cp*a**2*b**5+78848.0_cp &
      &              *a*b**6*dn**2+394240.0_cp*a*b**6*dn-2936832.0_cp*a*b**6-45056.0_cp* &
      &              b**7*dn**2-225280.0_cp*b**7*dn+1204224.0_cp*b**7)/(8192.0_cp*dn*(dn &
      &              -3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+1)=3.0_cp*a**8*(33.0_cp*a**8*dn**2-357.0_cp*a**8+384.0_cp &
      &              *a**7*b*dn**2-4736.0_cp*a**7*b+1952.0_cp*a**6*b**2*dn**2-28128.0_cp &
      &              *a**6*b**2+5632.0_cp*a**5*b**3*dn**2-91648.0_cp*a**5*b**3+10656.0_cp &
      &              *a**4*b**4*dn**2-107424.0_cp*a**4*b**4+21504.0_cp*a**3*b**5*dn**2+1188864.0_cp &
      &              *a**3*b**5+123904.0_cp*a**2*b**6*dn**2-4074496.0_cp*a**2*b**6-90112.0_cp &
      &              *a*b**7*dn**2+3923968.0_cp*a*b**7+135168.0_cp*b**8*dn**2-1953792.0_cp &
      &              *b**8)/(32768.0_cp*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)* &
      &              (dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+2)=a**8*b*(9.0_cp*a**7*dn**2-45.0_cp*a**7*dn+294.0_cp*a**7+ &
      &              192.0_cp*a**6*b*dn**2-960.0_cp*a**6*b*dn+3072.0_cp*a**6*b+1616.0_cp &
      &              *a**5*b**2*dn**2-8080.0_cp*a**5*b**2*dn+9216.0_cp*a**5*b**2+7168.0_cp &
      &              *a**4*b**3*dn**2-35840.0_cp*a**4*b**3*dn-49152.0_cp*a**4*b**3+15296.0_cp &
      &              *a**3*b**4*dn**2-76480.0_cp*a**3*b**4*dn-1094784.0_cp*a**3*b**4-43520.0_cp &
      ...
      &              b**7*dn**2+225280.0_cp*b**7*dn+1204224.0_cp*b**7)/(8192.0_cp*dn*(dn &
      &              -3.0_cp)*(dn-2.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+3)=-a**8*(22.0_cp*a**8*dn**2+209.0_cp*a**8*dn+255.0_cp*a**8 &
      &              +216.0_cp*a**7*b*dn**2+2592.0_cp*a**7*b*dn+3720.0_cp*a**7*b+1014.0_cp &
      &              *a**6*b**2*dn**2+13512.0_cp*a**6*b**2*dn+24738.0_cp*a**6*b**2+4096.0_cp &
      &              *a**5*b**3*dn**2+34304.0_cp*a**5*b**3*dn+90624.0_cp*a**5*b**3+18016.0_cp &
      &              *a**4*b**4*dn**2+23840.0_cp*a**4*b**4*dn+103296.0_cp*a**4*b**4+59648.0_cp &
      ...
      stencil(ku+4)=-3.0_cp*a**8*b*(19.0_cp*a**7*dn**2-21.0_cp*a**7*dn-114.0_cp &
      &              *a**7+272.0_cp*a**6*b*dn**2-48.0_cp*a**6*b*dn-1632.0_cp*a**6*b+1564.0_cp &
      &              *a**5*b**2*dn**2+1772.0_cp*a**5*b**2*dn-9640.0_cp*a**5*b**2+4096.0_cp &
      &              *a**4*b**3*dn**2+16384.0_cp*a**4*b**3*dn-18432.0_cp*a**4*b**3+1856.0_cp &
      &              *a**3*b**4*dn**2+55616.0_cp*a**3*b**4*dn+276864.0_cp*a**3*b**4+1024.0_cp &
      &              *a**2*b**5*dn**2-177152.0_cp*a**2*b**5*dn-627712.0_cp*a**2*b**5+22528.0_cp &
      &              *a*b**6*dn**2+247808.0_cp*a*b**6*dn+550912.0_cp*a*b**6-20480.0_cp*b**7 &
      &              *dn**2-118784.0_cp*b**7*dn-172032.0_cp*b**7)/(8192.0_cp*dn*(dn-2.0_cp &
      &              )*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+5)=-a**8*(22.0_cp*a**8*dn**3-99.0_cp*a**8*dn**2-328.0_cp &
      &              *a**8*dn+201.0_cp*a**8+304.0_cp*a**7*b*dn**3-960.0_cp*a**7*b*dn**2-4816.0_cp &
      &              *a**7*b*dn+1440.0_cp*a**7*b+1268.0_cp*a**6*b**2*dn**3-2208.0_cp*a** &
      &              6*b**2*dn**2-26492.0_cp*a**6*b**2*dn-9288.0_cp*a**6*b**2-320.0_cp*a**5 &
      &              *b**3*dn**3+3456.0_cp*a**5*b**3*dn**2-34240.0_cp*a**5*b**3*dn-150144.0_cp &
      ...
      &              /(16384.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn &
      &              +2.0_cp)*(dn+3.0_cp))
      stencil(ku+6)=a**8*b*(97.0_cp*a**7*dn**3-6.0_cp*a**7*dn**2-1033.0_cp &
      &              *a**7*dn+54.0_cp*a**7+1040.0_cp*a**6*b*dn**3+1248.0_cp*a**6*b*dn**2 &
      &              -12560.0_cp*a**6*b*dn-5472.0_cp*a**6*b+3740.0_cp*a**5*b**2*dn**3+14472.0_cp &
      &              *a**5*b**2*dn**2-46940.0_cp*a**5*b**2*dn-89448.0_cp*a**5*b**2+3072.0_cp &
      &              *a**4*b**3*dn**3+43008.0_cp*a**4*b**3*dn**2+64512.0_cp*a**4*b**3*dn &
      ...
      &              dn**2-380928.0_cp*b**7*dn-368640.0_cp*b**7)/(8192.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+7)=3.0_cp*a**8*(10.0_cp*a**8*dn**3+17.0_cp*a**8*dn**2-85.0_cp &
      &              *a**8*dn-78.0_cp*a**8+104.0_cp*a**7*b*dn**3+304.0_cp*a**7*b*dn**2-776.0_cp &
      &              *a**7*b*dn-1296.0_cp*a**7*b+282.0_cp*a**6*b**2*dn**3+1580.0_cp*a**6 &
      &              *b**2*dn**2+222.0_cp*a**6*b**2*dn-6660.0_cp*a**6*b**2-1792.0_cp*a** &
      &              5*b**3*dn**2+19200.0_cp*a**5*b**3*dn+19968.0_cp*a**5*b**3+2352.0_cp &
      ...
      &              +110592.0_cp*b**8*dn+73728.0_cp*b**8)/(16384.0_cp*dn*(dn-3.0_cp)*(dn &
      &              -2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+8)=-a**8*b*(49.0_cp*a**7*dn**3+294.0_cp*a**7*dn**2-301.0_cp &
      &              *a**7*dn-1026.0_cp*a**7+224.0_cp*a**6*b*dn**3+3648.0_cp*a**6*b*dn** &
      &              2+1504.0_cp*a**6*b*dn-12672.0_cp*a**6*b-632.0_cp*a**5*b**2*dn**3+11760.0_cp &
      &              *a**5*b**2*dn**2+41288.0_cp*a**5*b**2*dn-20640.0_cp*a**5*b**2-512.0_cp &
      &              *a**4*b**3*dn**3-21504.0_cp*a**4*b**3*dn**2+86528.0_cp*a**4*b**3*dn &
      ...
      &              +45056.0_cp*b**7*dn+24576.0_cp*b**7)/(8192.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp &
      &              )*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+9)=-a**8*(9.0_cp*a**8*dn**3+75.0_cp*a**8*dn**2+39.0_cp*a**8 &
      &              *dn-165.0_cp*a**8+32.0_cp*a**7*b*dn**3+768.0_cp*a**7*b*dn**2+1312.0_cp &
      &              *a**7*b*dn-1152.0_cp*a**7*b-8.0_cp*a**6*b**2*dn**3+384.0_cp*a**6*b**2* &
      &              dn**2+6872.0_cp*a**6*b**2*dn+9504.0_cp*a**6*b**2+3200.0_cp*a**5*b** &
      &              3*dn**3-13824.0_cp*a**5*b**3*dn**2-49280.0_cp*a**5*b**3*dn+62976.0_cp &
      ...
      &              *b**8*dn**2-11264.0_cp*b**8*dn-6144.0_cp*b**8)/(16384.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+10)=-3.0_cp*a**9*b*(9.0_cp*a**6*dn**3-54.0_cp*a**6*dn**2 &
      &              -181.0_cp*a**6*dn+66.0_cp*a**6+160.0_cp*a**5*b*dn**3-192.0_cp*a**5* &
      &              b*dn**2-2400.0_cp*a**5*b*dn-1152.0_cp*a**5*b+536.0_cp*a**4*b**2*dn**3+ &
      &              1968.0_cp*a**4*b**2*dn**2-3944.0_cp*a**4*b**2*dn-15072.0_cp*a**4*b**2- &
      &              1536.0_cp*a**3*b**3*dn**3+3072.0_cp*a**3*b**3*dn**2+44544.0_cp*a**3 &
      &              *b**3*dn+64512.0_cp*a**3*b**3-4896.0_cp*a**2*b**4*dn**3-35136.0_cp* &
      &              a**2*b**4*dn**2-82656.0_cp*a**2*b**4*dn-63936.0_cp*a**2*b**4+4352.0_cp &
      &              *a*b**5*dn**3+26112.0_cp*a*b**5*dn**2+47872.0_cp*a*b**5*dn+26112.0_cp &
      &              *a*b**5-512.0_cp*b**6*dn**3-3072.0_cp*b**6*dn**2-5632.0_cp*b**6*dn-3072.0_cp &
      &              *b**6)/(8192.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp &
      &              )*(dn+2.0_cp)*(dn+3.0_cp))
      stencil(ku+11)=-a**10*(6.0_cp*a**6*dn**3-15.0_cp*a**6*dn**2-99.0_cp &
      &              *a**6*dn-30.0_cp*a**6+88.0_cp*a**5*b*dn**3+48.0_cp*a**5*b*dn**2-952.0_cp &
      &              *a**5*b*dn-912.0_cp*a**5*b-106.0_cp*a**4*b**2*dn**3+1068.0_cp*a**4* &
      &              b**2*dn**2+3634.0_cp*a**4*b**2*dn-1572.0_cp*a**4*b**2-4096.0_cp*a** &
      &              3*b**3*dn**3-8448.0_cp*a**3*b**3*dn**2+35584.0_cp*a**3*b**3*dn+72192.0_cp &
      ...
      &              *dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp)*(dn &
      &              +3.0_cp))
      stencil(ku+12)=a**11*b*(43.0_cp*a**4*dn**2-63.0_cp*a**4*dn-118.0_cp &
      &              *a**4+368.0_cp*a**3*b*dn**2+144.0_cp*a**3*b*dn-1184.0_cp*a**3*b+132.0_cp &
      &              *a**2*b**2*dn**2+2556.0_cp*a**2*b**2*dn+4584.0_cp*a**2*b**2-3072.0_cp &
      &              *a*b**3*dn**2-9216.0_cp*a*b**3*dn-6144.0_cp*a*b**3+1440.0_cp*b**4*dn**2 &
      &              +4320.0_cp*b**4*dn+2880.0_cp*b**4)/(8192.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp &
      &              )*(dn-1.0_cp)*(dn+1.0_cp)*(dn+2.0_cp))
      stencil(ku+13)=3.0_cp*a**12*(2.0_cp*a**4*dn**2-a**4*dn-5.0_cp*a**4+16.0_cp &
      &              *a**3*b*dn**2+16.0_cp*a**3*b*dn-32.0_cp*a**3*b-68.0_cp*a**2*b**2*dn**2 &
      &              +44.0_cp*a**2*b**2*dn+360.0_cp*a**2*b**2-448.0_cp*a*b**3*dn**2-1344.0_cp &
      &              *a*b**3*dn-896.0_cp*a*b**3+428.0_cp*b**4*dn**2+1284.0_cp*b**4*dn+856.0_cp &
      &              *b**4)/(16384.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp &
      &              )*(dn+2.0_cp))
      stencil(ku+14)=-a**13*b*(19.0_cp*a**2*dn-17.0_cp*a**2+80.0_cp*a*b*dn &
      &              +80.0_cp*a*b-180.0_cp*b**2*dn-180.0_cp*b**2)/(8192.0_cp*dn*(dn-3.0_cp &
      &              )*(dn-2.0_cp)*(dn-1.0_cp)*(dn+1.0_cp))
      stencil(ku+15)=-a**14*(2.0_cp*a**2*dn-a**2+8.0_cp*a*b*dn+8.0_cp*a*b &
      &              -62.0_cp*b**2*dn-62.0_cp*b**2)/(16384.0_cp*dn*(dn-3.0_cp)*(dn-2.0_cp &
      &              )*(dn-1.0_cp)*(dn+1.0_cp))
