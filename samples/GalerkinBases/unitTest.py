...
class TestGalerkinBases(unittest.TestCase):

    def __init__(self, testName, dir, execCmd='mpirun -n 8 ../tmp/pizza.exe', 
                 precision=1e-8):
        super(TestGalerkinBases, self).__init__(testName)
        self.dir = dir
        self.precision = precision
        self.execCmd = execCmd
        self.startDir = os.getcwd()
        self.description = "Test several Galerkin bases"
    ...
    def setUp(self):
        ...
        cmd = f'{self.execCmd} {self.dir}/input_first_continue.nml'
        sp.call(cmd, shell=True, stdout=open(os.devnull, 'wb'),
                stderr=open(os.devnull, 'wb'))
        cmd = f'{self.execCmd} {self.dir}/input_second_continue.nml'
        sp.call(cmd, shell=True, stdout=open(os.devnull, 'wb'),
                stderr=open(os.devnull, 'wb'))
    ...
    def outputFileDiff(self):
        ...
        datTmp = readStack(f'{self.dir}/e_kin.test')
